...
export const reviews = [
  {
    id: 1,
    name: "Shyam sundar chauhan",
    location: "Mumbai",
    rating: 5,
    text: "Great service from S.S Global Pest Control Services. The staff was polite, professional, and completed the treatment properly. Highly recommended for residential pest control.",
  },
  {
    id: 2,
    name: "Sundar Rajput",
    location: "Mumbai",
    rating: 5,
    text: "Really satisfied with the service. The technician was punctual, polite, and professional. Everything was handled smoothly. Great experience!",
  },
  {
    id: 3,
    ...
    location: "Mumbai",
    rating: 5,
    text: "Great experience with S.S. Global Pest Control Services! Professional team, smooth service, and excellent results. Everything was handled perfectly from start to finish. Definitely recommended!",
  },
  {
    id: 4,
    name: "Neetu chauhan",
    location: "Mumbai",
    rating: 5,
    text: "Highly recommended S.S Global Pest Control Services. Excellent communication, professional treatment, and customer-friendly service. Very happy with the overall experience!",
  },
  {
    id: 5,
    name: "Nikita Gupta",
    location: "Mumbai",
    rating: 5,
    text: "Great pest control service in Mumbai. The staff was polite, responsive, and completed the work neatly. Highly recommended.",
  },
  {
    id: 6,
    name: "Akshay Gonbare",
    location: "Mumbai",
    rating: 5,
    text: "Outstanding pest control service! Really happy with the service from S.S Global Pest Control Services. The team was professional, punctual, and explained the treatment process clearly.",
  },
];
